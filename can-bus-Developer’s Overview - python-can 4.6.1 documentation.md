7/17/26, 12:53 AM Developer’s Overview \- python-can 4.6.1 documentation **Developer’s Overview** 
...
If you’re new to the codebase, see the next section for an overview of the code structure. For more about the internals, see Internal API and information on extending the can.io module. 
...
https://python-can.readthedocs.io/en/stable/development.html 1/6  
7/17/26, 12:53 AM Developer’s Overview \- python-can 4.6.1 documentation **Step-by-Step Contribution Guide** 
...
To run a local script (e.g., *snippet.py*) using your current python-can code, you can use either the   
Skip to content   
~~traditional *vir*~~*tualenv* and *pip* workflow or the modern *uv* tool. **ClickSend MCP Server.** Your AI can write code. Now it can send SMS. **Find out Traditional method (virtualenv \+ pip):**   
**more.** 
...
https://python-can.readthedocs.io/en/stable/development.html 2/6  
7/17/26, 12:53 AM Developer’s Overview \- python-can 4.6.1 documentation Create a virtual environment and install the package in editable mode. This allows changes to your local code to be reflected immediately, without reinstalling. 
...
*\# Upgrade pip and install python-can in editable mode with development dependencies* python \-m pip install \--upgrade pip 
...
If you fix a bug or add a feature, add or update tests in the test/ directory. If your change affects users, update documentation in doc/ and relevant docstrings. 4\. **Test Your Changes** 
...
https://python-can.readthedocs.io/en/stable/development.html 3/6  
7/17/26, 12:53 AM Developer’s Overview \- python-can 4.6.1 documentation 
...
News fragments are short files describing your change, stored in doc/changelog.d . Name each fragment \<issue-or-description\>.\<type\>.md , where \<type\> is one of: added , changed , deprecated , removed , fixed , or security . 
...
https://python-can.readthedocs.io/en/stable/development.html 4/6  
7/17/26, 12:53 AM Developer’s Overview \- python-can 4.6.1 documentation 7\. **Push and Submit Your Contribution** 
...
Please note: Pull requests that attempt to add new hardware interfaces directly to the python-can codebase will not be accepted. Instead, we encourage contributors to create plugins by publishing a Python package containing your can.BusABC subclass and using it within the python-can API. We will mention your package in this documentation and add it as an optional dependency. For current best practices, please refer to Plugin Interface. 
...
Create a module (either a \*.py or an entire subdirectory depending on the complexity) inside can.interfaces . See can/interfaces/socketcan for a reference implementation. Implement the central part of the backend: the bus class that extends can.BusABC . See Extending the BusABC class for more info on this one\! 

Register your backend bus class in BACKENDS in the file can.interfaces.\_\_init\_\_.py . Add docs where appropriate. At a minimum add to doc/interfaces.rst and add a new interface specific document in doc/interface/\* . It should document the supported platforms and also the hardware/software it requires. A small snippet of how to install the dependencies would also be useful to get people started without much friction. 

Also, don’t forget to document your classes, methods and function with docstrings. Add tests in test/\* where appropriate. For example, see test/back2back\_test.py and add a test case like BasicTestSocketCan for your new interface. 
...
https://python-can.readthedocs.io/en/stable/development.html 5/6  
7/17/26, 12:53 AM Developer’s Overview \- python-can 4.6.1 documentation **Creating a new Release** 
...
https://python-can.readthedocs.io/en/stable/development.html 6/6